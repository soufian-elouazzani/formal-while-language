...
Proof.
  unfold Pcarre_2.
  eapply SOS_again.
  {Compute (evalB(Bnot(Beqnat Ir (Aco 2))) [0;0;1]). eapply SOS1_While.}
  {
    eapply SOS_again.
    + Compute(evalB(Bnot(Beqnat Ir (Aco 2))) [0;0;1]). eapply SOS1_If_true. cbn. reflexivity.
    +eapply SOS_again.
    -unfold corps_carre. eapply SOS1_Seqi. unfold incrI. eapply SOS1_Seqf. apply SOS1_Assign.
    -eapply SOS_again.
     --cbn. eapply SOS1_Seqi. unfold incrX. eapply SOS1_Seqf. apply SOS1_Assign.
     --cbn. eapply SOS_again.
       ---unfold incrY. eapply SOS1_Seqf. apply SOS1_Assign.
       ---cbn. eapply SOS_again.
          ----eapply SOS1_While.
          ----eapply SOS_again.
              -----Compute(evalB(Bnot(Beqnat Ir (Aco 2))) [1;1;3]). apply SOS1_If_true. cbn. reflexivity.
              -----eapply SOS_again.
     *eapply SOS1_Seqi. eapply SOS1_Seqf. unfold incrI. apply SOS1_Assign.
     *cbn. eapply SOS_again.
      **eapply SOS1_Seqi. eapply SOS1_Seqf. apply SOS1_Assign.
      **cbn. eapply SOS_again.
        ***eapply SOS1_Seqf. apply SOS1_Assign.
        ***cbn. eapply SOS_again.
           ****apply SOS1_While.
           ****eapply SOS_again.
               *****Compute(evalB(Bnot(Beqnat Ir (Aco 2))) [2;4;5]). apply SOS1_If_false. cbn. reflexivity.
               *****eapply SOS_again.
               ******apply SOS1_Skip.
               ******apply SOS_stop.
